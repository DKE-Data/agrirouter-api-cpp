...
class MessageProvider {
 public:
  ...
  std::list<AgrirouterMessage> getImageMessage(std::string *messageId, std::vector<int32_t> seqNos, Addressing addressing, const std::string &teamSetContextId, char *image, int size);
  std::list<AgrirouterMessage> getTaskdataZipMessage(std::string *messageId, std::vector<int32_t> seqNos, Addressing addressing, const std::string &teamSetContextId, char *taskdataZip, int size);
 ...
 private:
  ...
  std::list<AgrirouterMessage> getChunkedMessages(std::string *messageId, std::vector<int32_t> seqNos, Addressing addressing, const std::string &teamSetContextId, char *unchunkedData, int size, std::string technicalMessageType);
};
